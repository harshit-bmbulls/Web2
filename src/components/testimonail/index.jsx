...
//   return (
//     <div className="min-h-screen mt-20 bg-black max-w-[1200px] mx-auto">
//       <div className="">
//         <div className="mb-8">
//           <div className="text-white opacity-60 text-[48px] text-center mb-4">
//             <TextAnimate as="h2" animation="blurInUp" by="word">
//               Clients who stopped losing deals
//             </TextAnimate>
//           </div>

//           <div className="text-center text-white opacity-60 text-[16px]">
//             <TextAnimate
//               animation="blurInUp"
//               as="p"
//               delay={0.3}
...
//         <div className="grid grid-cols-3 gap-3 h-[750px]">
//           {/* Left Column */}
