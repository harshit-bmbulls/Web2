...
const FeatureCard = ({ feature, radialGradient, cardMaskStyle }) => (
  ...
  >
    ...
    <p className="text-white/50  text-[13px] xs:text-[14px] sm:text-[15px] md:text-base leading-[18px] xs:leading-[19px] sm:leading-[21px] md:leading-6 relative z-20 break-words">
      {feature.desc}
    </p>
  </div>
);
