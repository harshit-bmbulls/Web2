      ...
      <motion.button
        ...
        <div className="relative z-40 p-8 ">
          <motion.p
            ...
            className="text-left  font-sans text-sm font-medium text-white opacity-80 md:text-base">
            {card.category}
          </motion.p>
          <motion.p
            layoutId={layout ? `title-${card.title}` : undefined}
            className="mt-2 max-w-xs text-left font-sans text-[48px]  [text-wrap:balance] text-white opacity-80 md:text-3xl">
            {card.title}
          </motion.p>
        </div>
        <BlurImage
